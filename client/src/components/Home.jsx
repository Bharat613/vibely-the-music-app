...
  const teluguHeroes = [
    { name: 'Mahesh Babu', query: 'Mahesh Babu hit songs', image: '/images/maheshbabu-art.jpg' },
    { name: 'Prabhas', query: 'Prabhas hit songs', image: '/images/prabhas-art.jpg' },
    { name: 'Allu Arjun', query: 'Allu Arjun hit songs', image: '/images/alluarjun-art.jpg' },
    { name: 'Nani', query: 'Nani hit songs', image: '/images/nani-art.jpg' },
  ];
...
        )}
        
        {/* --- New Telugu Hero's Hits Section --- */}
        {teluguHeroes.length > 0 && (
          <div className="section famous-singers-section">
            <h2 className="section-title">Telugu Hero's Hits</h2>
            <div className="song-list">
              {teluguHeroes.map((hero, index) => (
                hero && (
                  <div
                    key={`hero-${index}`}
                    className="song-item"
                    // Re-using onSingerClick since the logic is the same (fetch songs by query)
                    onClick={() => onSingerClick(hero)} 
                  >
                    <img src={hero.image || '/images/default-singer-art.png'} alt={hero.name || 'Hero Image'} />
                    <h4>{hero.name || 'Unknown Hero'}</h4>
                  </div>
                )
              ))}
            </div>
